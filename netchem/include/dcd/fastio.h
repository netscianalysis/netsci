...
static fio_size_t fio_fread(void *ptr, fio_size_t _size,
...
static fio_size_t fio_fwrite(void *ptr, fio_size_t _size,
                             fio_size_t nitems, fio_fd fd) {
  BOOL rc;
  DWORD len;
  DWORD writelen;
...
static fio_size_t fio_fread(void *ptr, fio_size_t _size,
                            fio_size_t nitems, fio_fd fd) {
  return fread(ptr, _size, nitems, fd);
}
...
static fio_size_t fio_fwrite(void *ptr, fio_size_t _size,
                             fio_size_t nitems, fio_fd fd) {
  return fwrite(ptr, _size, nitems, fd);
}
