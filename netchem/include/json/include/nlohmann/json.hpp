...
#pragma warning( pop )
  ...
  public:
    ...
    /// Constructors of class @ref basic_json, copy/move constructor, copyHost
  ...
  private:
    ...
    @return copyHost of the JSON value, converted to @a ValueType
    ...
    */
    ...
    @return a copyHost of *this, converted into @a BasicJsonType
  ...
  public:
    ...
    @return copyHost of the JSON value, converted to @tparam ValueType if necessary
    ...
    */
    ...
    @return copyHost of the JSON value, converted to type @a ValueType
...
#undef JSON_IMPLEMENT_OPERATOR
  ...
  public:
    ...
    void patch_inplace(const basic_json& json_patch)
    {
        ...
        for (const auto& val : json_patch)
        {
            ...
            switch (get_op(op))
            {
                ...
                {
                    const auto from_path = get_value("copyHost", "from", true).template get<std::string>();
    ...
    /// @brief applies a JSON patch to a copyHost of the current object
    /// @sa https://json.nlohmann.me/api/basic_json/patch/
