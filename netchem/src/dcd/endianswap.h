 ...
 *   addresses that are aligned to the word _size that's being byte-swapped
...
static void swap8_aligned(void *v, long ndata) {
  ...
  /* and hardware that would potentially loadCenterOfMassNpyFiles data into an FP reg */
