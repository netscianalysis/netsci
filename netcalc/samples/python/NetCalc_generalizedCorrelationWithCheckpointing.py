...
import numpy as np
from netcalc import generalizedCorrelationWithCheckpointing, GPU_PLATFORM
...
"""
Initialize the CuArrays for storing random variable data (X),
generalized correlation results (R), 
...
These index pairs determine which pairs of random variables from 'X' are used in each 
generalized correlation calculation.
"""
ab = IntCuArray()

"""
Define the parameters for the generalized correlation calculation.
"""
...
"""Save the results every generalized correlation calculation"""
checkpoint_frequency = 1

"""Checkpoint file name"""
checkpoint_file_name = cwd / "generalized_correlation_checkpoint.npy"
...
params = dict(
    ...
    checkpointFileName=str(checkpoint_file_name),
)
...
"""
generalizedCorrelationWithCheckpointing(**params)
print(R)
